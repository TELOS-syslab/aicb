            ...
            for layer in layers:
                ...
                if self.args.enable_sequence_parallel:
                    ...
                    if "embedding" in name:
                        ...
                        # 添加当前嵌入层的工作项
                        # print(f"??fth backward_comm_size={backward_comm_size} backward_compute_time={backward_compute_time} dp_compute_time={dp_compute_time} ")
                        self.workload.append(
                            Work_Item(
                                name=name,
                                forward_compute_time=emb_compute_time,  # 前向计算时间
