...
# fth 改成   from mockedsarathi.config import ParallelConfig
...
class ModelConfig:
    ...
    # MockedParam
    def get_num_q_heads(self, parallel_config: MockedParam):  # fth 250218 获取并行配置下的查询头数量
    ...
    def get_num_kv_heads(self, parallel_config: MockedParam):  # fth 250218 获取并行配置下的键值头数量
